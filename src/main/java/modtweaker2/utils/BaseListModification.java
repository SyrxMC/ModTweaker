...
public abstract class BaseListModification<T> extends BaseUndoable {
    ...
    public boolean canUndo() {
        if (recipes.isEmpty() || successful.isEmpty()) return false;
    ...
    /**
     * This method must be overwritten by the extending classes. It should return the name of the key item, for which
     * the recipe is for. For example for machines which produce new items, it should return the name of the ouput. For
     * machines which are processing items (like a pulverizer) it should return the name of the the input. Another
     * example would be the name of the enchantmant for a thaumcraft infusion recipe.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof BaseListModification<?>)) return false;
    ...
    /**
     * Compares two recipes if they are equal. If the mod does not overwrite equals() in their recipe object, this
     * method should be overwritten by the extending classes to add a custom equals method
     */
