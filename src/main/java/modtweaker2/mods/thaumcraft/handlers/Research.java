...
public class Research {
    ...
    private static final ResourceLocation defaultBackground = new ResourceLocation(
            "thaumcraft",
    ...
    @ZenMethod
    public static void addResearch(String key, String tab, @Optional String aspects, int x, int y, int difficulty,
    ...
    @ZenMethod
    public static void addResearch(String key, String tab, @Optional String aspects, int x, int y, int difficulty,
            IItemStack item, IItemStack[] triggers, String[] entTriggers, String aspectsTrigger) {
        ...
        MineTweakerAPI.apply(
                new AddResearch(
                        new ResearchItem(
                                ...
                                difficulty,
                                toStack(item)),
                        InputHelper.toStacks(triggers),
                        entTriggers,
                        ThaumcraftHelper.parseAspects(aspectsTrigger)));
    }
