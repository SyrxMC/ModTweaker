...
public class RockCrusher {
    ...
    public static void addRecipe(WeightedItemStack[] output, IItemStack input, @Optional Boolean matchEmptyNBT) {
        ...
        else recipe = RailcraftHelper.getRockCrusherRecipe(toStack(input), true, matchEmptyNBT);
    ...
    public static void removeRecipe(IIngredient input) {
        ...
        if (!recipes.isEmpty()) {
            ...
            LogHelper.logWarning(
                    String.format("No %s Recipe found for %s. Command ignored!", RockCrusher.name, input.toString()));
        }
    }
