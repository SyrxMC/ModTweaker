...
public class Reaction {
    ...
    public static void removeRecipe(IIngredient itemOutput, IIngredient gasOutput, @Optional IIngredient itemInput,
        ...
        for (Entry<PressurizedInput, PressurizedRecipe> entry : ((Map<PressurizedInput, PressurizedRecipe>) Recipe.PRESSURIZED_REACTION_CHAMBER
                .get()).entrySet()) {
        ...
        if (!recipes.isEmpty()) {
            ...
            LogHelper.logWarning(
                    String.format(
                            "No %s recipe found for %s, %s, %s, %s and %s. Command ignored!",
                            name,
                            itemOutput.toString(),
                            gasOutput.toString(),
                            itemInput.toString(),
