...
public class ThermalHelper {
    ...
    static {
        try {
            ...
            insolatorRecipe = getConstructor(
                    RecipeInsolator.class,
                    ItemStack.class,
                    ItemStack.class,
                    ItemStack.class,
                    ItemStack.class,
                    int.class,
                    int.class);
            pulverizerRecipe = getConstructor(
                    RecipePulverizer.class,
                    ItemStack.class,
                    ItemStack.class,
                    ItemStack.class,
                    int.class,
                    int.class);
            sawmillRecipe = getConstructor(
                    RecipeSawmill.class,
                    ItemStack.class,
                    ItemStack.class,
                    ItemStack.class,
            ...
            smelterRecipe = getConstructor(
                    ...
                    int.class,
                    int.class);
            transposerRecipe = getConstructor(
                    RecipeTransposer.class,
                    ItemStack.class,
                    ItemStack.class,
                    FluidStack.class,
                    int.class,
