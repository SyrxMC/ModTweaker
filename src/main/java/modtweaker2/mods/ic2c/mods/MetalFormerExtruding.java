...
@ZenClass("mods.ic2classic.MetalFormerExtruding")
public class MetalFormerExtruding {
    ...
    private static class Add extends BaseMapAddition<IRecipeInput, RecipeOutput> {
        ...
        protected Add(ItemStack output, ItemStack input) {
            super("MetalFormerExtruding", Recipes.metalformerExtruding.getRecipes());
    ...
    public static void removeRecipe(IItemStack output) {
        ...
        for (Entry<IRecipeInput, RecipeOutput> set : Recipes.metalformerExtruding.getRecipes().entrySet()) {
    ...
    private static class Remove extends BaseMapRemoval<IRecipeInput, RecipeOutput> {
        ...
        protected Remove(Map<IRecipeInput, RecipeOutput> recipes) {
            super("MetalFormerExtruding", Recipes.metalformerExtruding.getRecipes(), recipes);
        }
