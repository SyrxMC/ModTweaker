...
@ZenClass("mods.ic2classic.Extractor")
public class Extractor {
    ...
    public static void removeRecipe(IItemStack output) {
        ...
        for (Entry<IRecipeInput, RecipeOutput> set : Recipes.extractor.getRecipes().entrySet()) {
    ...
    private static class Remove extends BaseMapRemoval<IRecipeInput, RecipeOutput> {
        ...
        protected Remove(Map<IRecipeInput, RecipeOutput> recipes) {
            super("Extractor", Recipes.extractor.getRecipes(), recipes);
        }
